-- ============================================================================
-- 034 — key_active: bảng key kích hoạt ánh xạ orders.order_list (id + id_order)
-- Hạn (expires_at) đồng bộ với orders.order_list.expired_at.
-- Chạy trên DB đã có schema orders.order_list.
-- Idempotent: an toàn chạy lại (IF NOT EXISTS / DROP IF EXISTS + CREATE).
-- ============================================================================
