-- MAVN nhập hàng: giữ logged_at của dòng supplier_order_cost_log đúng "tháng lúc chuyển Đã Thanh Toán"
-- để dashboard total_profit (fn_recalc_dashboard_total_import) không bị nhảy sang tháng sau khi chỉnh cost/NCC sau này.
-- Logic: chỉ không ghi đè logged_at cho MAVN; MAVC/L/... giữ như cũ (NOW()).
