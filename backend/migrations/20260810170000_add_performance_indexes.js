exports.up = async function (knex) {
  await knex.raw(`
    ...
    CREATE INDEX IF NOT EXISTS idx_payment_receipt_order_code_lower ON billing.payment_receipt (LOWER(order_code));
    ...
    CREATE INDEX IF NOT EXISTS idx_refund_credit_notes_source_order_list_id ON receipt.refund_credit_notes (source_order_list_id);
    CREATE INDEX IF NOT EXISTS idx_refund_credit_applications_target_order_list_id ON receipt.refund_credit_applications (target_order_list_id);
  `);
};
...
exports.down = async function (knex) {
  await knex.raw(`
    ...
    DROP INDEX IF EXISTS billing.idx_payment_receipt_order_code_lower;
    DROP INDEX IF EXISTS business.idx_order_list_id_order_lower;
    DROP INDEX IF EXISTS receipt.idx_refund_credit_notes_source_order_list_id;
    DROP INDEX IF EXISTS receipt.idx_refund_credit_applications_target_order_list_id;
  `);
};
