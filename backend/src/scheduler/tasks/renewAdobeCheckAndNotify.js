 ...
 * Trigger `cron`: không chạy autoAssignUsers / AddUsers (tránh fillEmailInSlot khi B13 chậm).
 * Trigger `manual` (API /scheduler/run-adobe-check): vẫn có thể bật auto-assign — xem includeAutoAssign bên dưới.
