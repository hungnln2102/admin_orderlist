...
router.put("/:id", ...goalIdParam, async (req, res) => {
  try {
    ...
    logger.error("Error updating saving goal", { goalId: req.params.id, error: error.message, stack: error.stack });
...
router.delete("/:id", ...goalIdParam, async (req, res) => {
  try {
    ...
    logger.error("Error deleting saving goal", { goalId: req.params.id, error: error.message, stack: error.stack });
...
router.put("/:id/priority", ...updatePriorityRules, async (req, res) => {
  try {
    ...
    logger.error("Error updating goal priority", { goalId: req.params.id, error: error.message, stack: error.stack });
