...
const TABLES = {
  ...
  receiptFlowTypes: tableName(RECEIPT_SCHEMA.RECEIPT_FLOW_TYPES.TABLE, SCHEMA_RECEIPT),
  storeProfitExpenses: tableName(FINANCE_SCHEMA.STORE_PROFIT_EXPENSES.TABLE, SCHEMA_FINANCE),
};

const FLOW_TYPE_COLS = RECEIPT_SCHEMA.RECEIPT_FLOW_TYPES.COLS;
