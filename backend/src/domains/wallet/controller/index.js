...
const listDailyBalances = async (_req, res) => {
  try {
    ...
    balances.forEach((row) => {
      ...
      if (dateStr === COLUMN_TOTAL_RECORD_DATE) return;
    ...
    logger.error("[wallets] Failed to load daily balances", {
      error: error.message,
      stack: error.stack,
    });
    res
...
const saveDailyBalance = async (req, res) => {
  ...
  try {
    ...
    logger.error("[wallets] Failed to save daily balances", {
      error: error.message,
      stack: error.stack,
    });
...
const createWalletType = async (req, res) => {
  ...
  try {
    ...
    logger.error("[wallets] create type failed", {
      error: error.message,
      stack: error.stack,
    });
...
const deleteWalletType = async (req, res) => {
  ...
  try {
    ...
    logger.error("[wallets] delete type failed", {
      error: error.message,
      stack: error.stack,
    });
