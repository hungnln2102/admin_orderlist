...
const supplierChangeRoutes = require("@/domains/supplies/supplier-change/routes");
...
const publicContentRoutes = require("@/domains/content/public-content/routes");
const publicPricingRoutes = require("@/domains/products/public-pricing/routes");
...
const importPackagesRoutes = require("@/domains/import-packages/routes");
...
const systemConfigRoutes = require("@/domains/system-config/routes");
