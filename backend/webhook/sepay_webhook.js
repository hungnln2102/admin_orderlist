...
const ORDER_COLS = getDefinition("ORDER_LIST").columns;
const PAYMENT_RECEIPT_COLS = getDefinition("PAYMENT_RECEIPT").columns;
const PAYMENT_SUPPLY_COLS = getDefinition("PAYMENT_SUPPLY").columns;
...
const PAYMENT_RECEIPT_TABLE = tableName("payment_receipt", DB_SCHEMA);
const ORDER_TABLE = tableName("order_list", DB_SCHEMA);
const PRODUCT_PRICE_TABLE = tableName("product_price", DB_SCHEMA);
const SUPPLY_TABLE = tableName("supply", DB_SCHEMA);
const SUPPLY_PRICE_TABLE = tableName("supply_price", DB_SCHEMA);
const PAYMENT_SUPPLY_TABLE = tableName("payment_supply", DB_SCHEMA);
