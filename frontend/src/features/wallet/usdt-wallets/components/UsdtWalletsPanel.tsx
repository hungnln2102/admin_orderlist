...
import { DeleteUsdtWalletModal } from "./DeleteUsdtWalletModal";
import { UsdtWalletBalanceTable } from "./UsdtWalletBalanceTable";
import { UsdtWalletFormModal } from "./UsdtWalletFormModal";
import { UsdtWalletTable } from "./UsdtWalletTable";
import { UsdtWalletWithdrawModal } from "./UsdtWalletWithdrawModal";
import type { UsdtWalletBalanceItem, UsdtWalletItem, UsdtWalletPayload } from "../types";

const PAGE_SIZE = 10;

export function UsdtWalletsPanel() {
